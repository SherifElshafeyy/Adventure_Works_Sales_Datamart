...
INSERT INTO dim_product
            (product_key, 
			product_id, product_name ,Product_description ,product_subcategory ,
			product_category ,color,model_name ,reorder_point ,standard_cost ,source_system_code ,start_date ,end_date ,is_current)
...
SET Name = 'SAMSAUNG S52', 
    color = 'WHITE',
	ModifiedDate = '2025-01-15 10:01:36.827'
WHERE ProductID = 1;

UPDATE production.product
SET Name = 'SHAOMI', 
    color = 'red',
	ModifiedDate = '2025-02-7 10:01:36.827'
WHERE ProductID = 1;
